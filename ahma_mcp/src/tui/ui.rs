...
//!
//! This module contains layout and widget rendering logic for the TUI.
//! When the `tui` Cargo feature is enabled, this uses `ratatui` widgets.
//! Otherwise it is a stub.
...
mod tests {
    use super::*;
    use crate::tui::app::{OperationSummary, TuiApp};
