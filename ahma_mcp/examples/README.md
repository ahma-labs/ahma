...
```
Loading cargo tool configuration from: /path/to/ahma/examples/configs/cargo.json
...
The examples use the `MtdfValidator` from `ahma::schema_validation` to validate configurations against the MTDF schema. This ensures:
...
- [ahma/src/schema_validation.rs](../src/schema_validation.rs) - Validation implementation
