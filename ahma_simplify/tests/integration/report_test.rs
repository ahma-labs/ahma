...
fn test_swift_and_objc_in_default_extensions() {
    use ahma_simplify::DEFAULT_EXTENSIONS;
...
fn test_from_external_confidence_cyclomatic_only() {
    use ahma_simplify::analysis::ExternalMetrics;
    use ahma_simplify::models::{AnalysisConfidence, FileSimplicity};
...
fn test_apply_external_updates_peak_cognitive() {
    use ahma_simplify::analysis::{ExternalIssue, ExternalMetrics, Severity};
    use ahma_simplify::models::{FileSimplicity, FunctionHotspot};
